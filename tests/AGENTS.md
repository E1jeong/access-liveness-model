...
- Test directories:
  ...
  - Model architectures: `tests/model/` (`test_conv1_reduction.py`, `test_efficientnet_lite.py`, `test_mobilefacenet.py`, `test_model_signature.py`, `test_pytorch_model.py`, `test_run_metadata.py`)
