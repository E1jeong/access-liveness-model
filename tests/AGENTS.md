...
- Test directories:
  ...
  - Model architectures & loss: `tests/model/` (`test_aux_depth.py`, `test_conv1_reduction.py`, `test_efficientnet_lite.py`, `test_focal_loss.py`, `test_model_signature.py`, `test_pytorch_model.py`, `test_run_metadata.py`, `test_supcon.py`, `test_training_enhancements.py`)
